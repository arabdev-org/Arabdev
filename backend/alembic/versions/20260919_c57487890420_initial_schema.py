...
def upgrade() -> None:
    ...
    sa.Column('remember', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    ...
    sa.Column('discoverable', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('show_follow_lists', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('mentions_from', sa.String(length=12), server_default='everyone', nullable=False),
    sa.Column('notify_likes', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('notify_comments', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('notify_follows', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('notify_reposts', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('notify_mentions', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('updated_at', app.models.types.UTCDateTime(), nullable=False),
